...
// License.
//
// The Original Code is PBBookMaker.cpp.
//
...
// ***** END LICENSE BLOCK *****
// ===========
// $Id: PBBookMaker.cp,v 1.19 2004/11/24 14:09:11 paul Exp $
// ===========
...
#define bookTemplateInstallPath  INSTALL_PREFIX "/share/DCL/pbbooktemplate.nsof"
...
/// \param inTemplateFrame	mod�le de bouquin.
		...
		if (inTemplatePath)
		{
			...
			try {
                ...
                try {
                    ...
                    theTemplateFile = new TDCLPOSIXFile( inFilesIntf, bookTemplateInstallPath );
                    theTemplateFile->Open( true );
                }
			}
...
main( int inArgc, char** inArgv )
{
	...
	{
		// On d�termine le nom du fichier de sortie en ajoutant .pkg.
	...
	if (thePackageName == nil)
	{
		if (theBookTitle == nil)
		{
			...
			if (theFilePath == nil)
			{
				...
				// � partir du nom du fichier texte.
